...
translate' (Up)                  ftab vtab is = (Up, ftab, vtab, (UpI:is))
translate' (Down)                ftab vtab is = (Down, ftab, vtab, (DownI:is))
-- translate' (MoveTo e1 e2)        ftab vtab is = 
translate' (Read s)              ftab vtab is = case lookupId s vtab of
    ...
    where ret i = ((Read s), ftab, vtab, (i:is))
