...
Clem Baker-Finch, January 1997.

This is based on a script written by Tim Lambert of UNSW.
Thanks Tim.
...
*************************************************************************
ALTERED FOR CGI TO OVERCOME drawTo LIMITATION OF WRITING TO FILE ONLY.
*************************************************************************
...
>   shift, rotate, scale, enlarge, shrink, draw, drawTo,
>   picToPS) where
...
*************************************************************************
Or just create the postscript as a string for sending along stdout
for CGI applications.

> picToPS :: Picture -> String
> picToPS pic = prologue ++ concat (map psObj pic)
