...
zip : src/Parse.y src/Tokenize.x src/PrettyPrint.hs src/AbsSyn.hs src/Translate.hs src/Desugar.hs Makefile README runTests.sh
	tar -zcvf turtle-u2546226.tar.gz src/Parse.y src/Tokenize.x src/PrettyPrint.hs src/AbsSyn.hs src/Translate.hs src/Desugar.hs Makefile README runTests.sh tests/*.t tests/*.p tests/*.d tools/PDPlot-Haskell/PDPlot.hs tools/PDPlot-Haskell/Graphics.lhs mytests/*.t tools/DisASM/DisASM.hs
